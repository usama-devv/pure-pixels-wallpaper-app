...
import 'package:pure_pixels_wallpaper_app/model/model.dart';
import 'package:http/http.dart' as http;

class Repository {
  final String apiKey =
      "omTqAbSacUVZ7d6rdC9zKQK9aFdBHQmFO9sPmyTJkJPMN28MFw1izNog";
        ...
        if (context.mounted) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              ...
              content: Text("Wallpaper has been saved at: ${file.path}"),
